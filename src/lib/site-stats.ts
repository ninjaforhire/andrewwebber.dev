...
// counter. overrides.json is written by scripts/refresh-stats.py (a monotonic
// ratchet — numbers never decrease); every stats refresh + commit rebuilds the
// site and these strings update with it.
//
